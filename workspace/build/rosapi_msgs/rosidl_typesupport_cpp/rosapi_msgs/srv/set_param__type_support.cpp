...
static const _SetParam_Event_type_support_symbol_names_t _SetParam_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosapi_msgs, srv, SetParam_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi_msgs, srv, SetParam_Event)),
  }
};
...
{
  return &::rosapi_msgs::srv::rosidl_typesupport_cpp::SetParam_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosapi_msgs, srv, SetParam_Event)() {
  return get_message_type_support_handle<rosapi_msgs::srv::SetParam_Event>();
}
...
static const rosidl_service_type_support_t SetParam_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rosapi_msgs::srv::SetParam_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rosapi_msgs::srv::SetParam_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rosapi_msgs::srv::SetParam_Event>(),
