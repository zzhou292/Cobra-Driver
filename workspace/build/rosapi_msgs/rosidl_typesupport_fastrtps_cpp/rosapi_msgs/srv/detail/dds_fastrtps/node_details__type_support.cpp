...
// functions for rosapi_msgs::srv::NodeDetails_Request already declared above

// functions for rosapi_msgs::srv::NodeDetails_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosapi_msgs
cdr_serialize(
  const rosapi_msgs::srv::NodeDetails_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosapi_msgs::srv::NodeDetails_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosapi_msgs
max_serialized_size_NodeDetails_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rosapi_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_NodeDetails_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rosapi_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_NodeDetails_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const rosapi_msgs::srv::NodeDetails_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rosapi_msgs::srv::NodeDetails_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NodeDetails_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rosapi_msgs::srv::NodeDetails_Event *>(
...
static size_t _NodeDetails_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NodeDetails_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NodeDetails_Event__callbacks = {
  "rosapi_msgs::srv",
  "NodeDetails_Event",
...
static rosidl_message_type_support_t _NodeDetails_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NodeDetails_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &rosapi_msgs::srv::typesupport_fastrtps_cpp::_NodeDetails_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosapi_msgs, srv, NodeDetails_Event)() {
  return &rosapi_msgs::srv::typesupport_fastrtps_cpp::_NodeDetails_Event__handle;
}
...
static const rosidl_service_type_support_t _NodeDetails__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NodeDetails__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rosapi_msgs::srv::NodeDetails_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rosapi_msgs::srv::NodeDetails_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rosapi_msgs::srv::NodeDetails_Event>(),
