...
static const _GetROSVersion_Event_type_support_symbol_names_t _GetROSVersion_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosapi_msgs, srv, GetROSVersion_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, GetROSVersion_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosapi_msgs, srv, GetROSVersion_Event)() {
  return &::rosapi_msgs::srv::rosidl_typesupport_c::GetROSVersion_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetROSVersion_service_type_support_handle = {
  ...
  &GetROSVersion_Request_message_type_support_handle,
  &GetROSVersion_Response_message_type_support_handle,
  &GetROSVersion_Event_message_type_support_handle,
