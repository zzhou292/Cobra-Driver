...
static const _ServiceNode_Event_type_support_symbol_names_t _ServiceNode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosapi_msgs, srv, ServiceNode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, ServiceNode_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosapi_msgs, srv, ServiceNode_Event)() {
  return &::rosapi_msgs::srv::rosidl_typesupport_c::ServiceNode_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ServiceNode_service_type_support_handle = {
  ...
  &ServiceNode_Request_message_type_support_handle,
  &ServiceNode_Response_message_type_support_handle,
  &ServiceNode_Event_message_type_support_handle,
