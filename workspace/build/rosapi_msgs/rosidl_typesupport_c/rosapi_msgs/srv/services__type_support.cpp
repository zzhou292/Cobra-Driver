...
static const _Services_Event_type_support_symbol_names_t _Services_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosapi_msgs, srv, Services_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, Services_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosapi_msgs, srv, Services_Event)() {
  return &::rosapi_msgs::srv::rosidl_typesupport_c::Services_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Services_service_type_support_handle = {
  ...
  &Services_Request_message_type_support_handle,
  &Services_Response_message_type_support_handle,
  &Services_Event_message_type_support_handle,
