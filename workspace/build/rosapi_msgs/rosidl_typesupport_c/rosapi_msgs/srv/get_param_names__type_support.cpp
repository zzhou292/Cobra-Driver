...
static const _GetParamNames_Event_type_support_symbol_names_t _GetParamNames_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosapi_msgs, srv, GetParamNames_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, GetParamNames_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosapi_msgs, srv, GetParamNames_Event)() {
  return &::rosapi_msgs::srv::rosidl_typesupport_c::GetParamNames_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetParamNames_service_type_support_handle = {
  ...
  &GetParamNames_Request_message_type_support_handle,
  &GetParamNames_Response_message_type_support_handle,
  &GetParamNames_Event_message_type_support_handle,
