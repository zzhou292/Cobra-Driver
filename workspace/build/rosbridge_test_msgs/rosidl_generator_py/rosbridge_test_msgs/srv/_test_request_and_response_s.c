...
ROSIDL_GENERATOR_C_EXPORT
bool rosbridge_test_msgs__srv__test_request_and_response__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosbridge_test_msgs.srv._test_request_and_response.TestRequestAndResponse_Event", full_classname_dest, 79) == 0);
  }
  rosbridge_test_msgs__srv__TestRequestAndResponse_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosbridge_test_msgs__srv__TestRequestAndResponse_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosbridge_test_msgs__srv__test_request_and_response__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rosbridge_test_msgs__srv__TestRequestAndResponse_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rosbridge_test_msgs__srv__test_request_and_response__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of TestRequestAndResponse_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosbridge_test_msgs.srv._test_request_and_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TestRequestAndResponse_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = rosbridge_test_msgs__srv__test_request_and_response__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = rosbridge_test_msgs__srv__test_request_and_response__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
