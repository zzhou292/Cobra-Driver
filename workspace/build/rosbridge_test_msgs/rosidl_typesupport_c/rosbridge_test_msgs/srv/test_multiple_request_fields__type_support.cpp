...
static const _TestMultipleRequestFields_Event_type_support_symbol_names_t _TestMultipleRequestFields_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestMultipleRequestFields_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestMultipleRequestFields_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestMultipleRequestFields_Event)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestMultipleRequestFields_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t TestMultipleRequestFields_service_type_support_handle = {
  ...
  &TestMultipleRequestFields_Request_message_type_support_handle,
  &TestMultipleRequestFields_Response_message_type_support_handle,
  &TestMultipleRequestFields_Event_message_type_support_handle,
