...
static const _TestEmpty_Event_type_support_symbol_names_t _TestEmpty_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestEmpty_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestEmpty_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestEmpty_Event)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestEmpty_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t TestEmpty_service_type_support_handle = {
  ...
  &TestEmpty_Request_message_type_support_handle,
  &TestEmpty_Response_message_type_support_handle,
  &TestEmpty_Event_message_type_support_handle,
