...
// functions for rosbridge_test_msgs::srv::TestRequestAndResponse_Request already declared above

// functions for rosbridge_test_msgs::srv::TestRequestAndResponse_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosbridge_test_msgs
cdr_serialize(
  const rosbridge_test_msgs::srv::TestRequestAndResponse_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosbridge_test_msgs::srv::TestRequestAndResponse_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosbridge_test_msgs
max_serialized_size_TestRequestAndResponse_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rosbridge_test_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_TestRequestAndResponse_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        rosbridge_test_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_TestRequestAndResponse_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const rosbridge_test_msgs::srv::TestRequestAndResponse_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rosbridge_test_msgs::srv::TestRequestAndResponse_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TestRequestAndResponse_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rosbridge_test_msgs::srv::TestRequestAndResponse_Event *>(
...
static size_t _TestRequestAndResponse_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestRequestAndResponse_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TestRequestAndResponse_Event__callbacks = {
  "rosbridge_test_msgs::srv",
...
static rosidl_message_type_support_t _TestRequestAndResponse_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TestRequestAndResponse_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &rosbridge_test_msgs::srv::typesupport_fastrtps_cpp::_TestRequestAndResponse_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbridge_test_msgs, srv, TestRequestAndResponse_Event)() {
  return &rosbridge_test_msgs::srv::typesupport_fastrtps_cpp::_TestRequestAndResponse_Event__handle;
}
...
static const rosidl_service_type_support_t _TestRequestAndResponse__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TestRequestAndResponse__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rosbridge_test_msgs::srv::TestRequestAndResponse_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rosbridge_test_msgs::srv::TestRequestAndResponse_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<rosbridge_test_msgs::srv::TestRequestAndResponse_Event>(),
