  ...
  rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    rosbridge_test_msgs__srv__TestRequestAndResponse_Request * data =
      (rosbridge_test_msgs__srv__TestRequestAndResponse_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__srv__TestRequestAndResponse_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__srv__TestRequestAndResponse_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    rosbridge_test_msgs__srv__TestRequestAndResponse_Response * data =
      (rosbridge_test_msgs__srv__TestRequestAndResponse_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__srv__TestRequestAndResponse_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__srv__TestRequestAndResponse_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
