...
class Metaclass_TestResponseOnly_Event(type):
    """Metaclass of message 'TestResponseOnly_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__test_response_only__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__test_response_only__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__test_response_only__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__test_response_only__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__test_response_only__event
...
class TestResponseOnly_Event(metaclass=Metaclass_TestResponseOnly_Event):
    """Message class 'TestResponseOnly_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rosbridge_test_msgs/TestResponseOnly_Request, 1>',
        'response': 'sequence<rosbridge_test_msgs/TestResponseOnly_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbridge_test_msgs', 'srv'], 'TestResponseOnly_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbridge_test_msgs', 'srv'], 'TestResponseOnly_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rosbridge_test_msgs.srv import TestResponseOnly_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, TestResponseOnly_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'TestResponseOnly_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rosbridge_test_msgs.srv import TestResponseOnly_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TestResponseOnly_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'TestResponseOnly_Response'"
...
class Metaclass_TestResponseOnly(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _test_response_only.Metaclass_TestResponseOnly_Event._TYPE_SUPPORT is None:
                _test_response_only.Metaclass_TestResponseOnly_Event.__import_type_support__()
...
class TestResponseOnly(metaclass=Metaclass_TestResponseOnly):
    ...
    from rosbridge_test_msgs.srv._test_response_only import TestResponseOnly_Event as Event
