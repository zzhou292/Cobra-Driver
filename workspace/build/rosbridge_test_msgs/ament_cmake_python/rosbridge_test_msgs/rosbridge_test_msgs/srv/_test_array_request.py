...
class Metaclass_TestArrayRequest_Event(type):
    """Metaclass of message 'TestArrayRequest_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__test_array_request__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__test_array_request__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__test_array_request__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__test_array_request__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__test_array_request__event
...
class TestArrayRequest_Event(metaclass=Metaclass_TestArrayRequest_Event):
    """Message class 'TestArrayRequest_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rosbridge_test_msgs/TestArrayRequest_Request, 1>',
        'response': 'sequence<rosbridge_test_msgs/TestArrayRequest_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbridge_test_msgs', 'srv'], 'TestArrayRequest_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbridge_test_msgs', 'srv'], 'TestArrayRequest_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rosbridge_test_msgs.srv import TestArrayRequest_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TestArrayRequest_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'TestArrayRequest_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rosbridge_test_msgs.srv import TestArrayRequest_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TestArrayRequest_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'TestArrayRequest_Response'"
...
class Metaclass_TestArrayRequest(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _test_array_request.Metaclass_TestArrayRequest_Event._TYPE_SUPPORT is None:
                _test_array_request.Metaclass_TestArrayRequest_Event.__import_type_support__()
...
class TestArrayRequest(metaclass=Metaclass_TestArrayRequest):
    ...
    from rosbridge_test_msgs.srv._test_array_request import TestArrayRequest_Event as Event
