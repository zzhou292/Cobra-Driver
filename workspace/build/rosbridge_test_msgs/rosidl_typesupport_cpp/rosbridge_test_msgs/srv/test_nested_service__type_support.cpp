...
static const _TestNestedService_Event_type_support_symbol_names_t _TestNestedService_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbridge_test_msgs, srv, TestNestedService_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbridge_test_msgs, srv, TestNestedService_Event)),
  }
};
...
{
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_cpp::TestNestedService_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosbridge_test_msgs, srv, TestNestedService_Event)() {
  return get_message_type_support_handle<rosbridge_test_msgs::srv::TestNestedService_Event>();
}
...
static const rosidl_service_type_support_t TestNestedService_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rosbridge_test_msgs::srv::TestNestedService_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rosbridge_test_msgs::srv::TestNestedService_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rosbridge_test_msgs::srv::TestNestedService_Event>(),
