...
using _TestRequestOnly_Event__ros_msg_type = rosbridge_test_msgs__srv__TestRequestOnly_Event;

static bool _TestRequestOnly_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const _TestRequestOnly_Event__ros_msg_type * ros_message = static_cast<const _TestRequestOnly_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestRequestOnly_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestRequestOnly_Response
      )()->data);
...
static bool _TestRequestOnly_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  _TestRequestOnly_Event__ros_msg_type * ros_message = static_cast<_TestRequestOnly_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      rosbridge_test_msgs__srv__TestRequestOnly_Request__Sequence__fini(&ros_message->request);
    }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      rosbridge_test_msgs__srv__TestRequestOnly_Response__Sequence__fini(&ros_message->response);
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosbridge_test_msgs
size_t get_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TestRequestOnly_Event__ros_msg_type * ros_message = static_cast<const _TestRequestOnly_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _TestRequestOnly_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosbridge_test_msgs
size_t max_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _TestRequestOnly_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_TestRequestOnly_Event = {
  "rosbridge_test_msgs::srv",
  "TestRequestOnly_Event",
  _TestRequestOnly_Event__cdr_serialize,
  _TestRequestOnly_Event__cdr_deserialize,
  _TestRequestOnly_Event__get_serialized_size,
  _TestRequestOnly_Event__max_serialized_size
};

static rosidl_message_type_support_t _TestRequestOnly_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TestRequestOnly_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestRequestOnly_Event)() {
  return &_TestRequestOnly_Event__type_support;
}
...
static rosidl_service_type_support_t TestRequestOnly__handle = {
  ...
  &_TestRequestOnly_Request__type_support,
  &_TestRequestOnly_Response__type_support,
  &_TestRequestOnly_Event__type_support,
