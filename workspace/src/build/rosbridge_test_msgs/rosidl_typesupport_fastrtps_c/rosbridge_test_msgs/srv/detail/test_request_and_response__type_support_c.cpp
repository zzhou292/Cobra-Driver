...
using _TestRequestAndResponse_Event__ros_msg_type = rosbridge_test_msgs__srv__TestRequestAndResponse_Event;

static bool _TestRequestAndResponse_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const _TestRequestAndResponse_Event__ros_msg_type * ros_message = static_cast<const _TestRequestAndResponse_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestRequestAndResponse_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestRequestAndResponse_Response
      )()->data);
...
static bool _TestRequestAndResponse_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  _TestRequestAndResponse_Event__ros_msg_type * ros_message = static_cast<_TestRequestAndResponse_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence__fini(&ros_message->request);
    }
    if (!rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence__init(&ros_message->request, size)) {
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence__fini(&ros_message->response);
    }
    if (!rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence__init(&ros_message->response, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosbridge_test_msgs
size_t get_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TestRequestAndResponse_Event__ros_msg_type * ros_message = static_cast<const _TestRequestAndResponse_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _TestRequestAndResponse_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosbridge_test_msgs
size_t max_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _TestRequestAndResponse_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_TestRequestAndResponse_Event = {
  "rosbridge_test_msgs::srv",
  "TestRequestAndResponse_Event",
  _TestRequestAndResponse_Event__cdr_serialize,
  _TestRequestAndResponse_Event__cdr_deserialize,
  _TestRequestAndResponse_Event__get_serialized_size,
  _TestRequestAndResponse_Event__max_serialized_size
};

static rosidl_message_type_support_t _TestRequestAndResponse_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TestRequestAndResponse_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestRequestAndResponse_Event)() {
  return &_TestRequestAndResponse_Event__type_support;
}
...
static rosidl_service_type_support_t TestRequestAndResponse__handle = {
  ...
  &_TestRequestAndResponse_Request__type_support,
  &_TestRequestAndResponse_Response__type_support,
  &_TestRequestAndResponse_Event__type_support,
