...
static const _TestRequestOnly_Event_type_support_symbol_names_t _TestRequestOnly_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestRequestOnly_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestRequestOnly_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestRequestOnly_Event)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestRequestOnly_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t TestRequestOnly_service_type_support_handle = {
  ...
  &TestRequestOnly_Request_message_type_support_handle,
  &TestRequestOnly_Response_message_type_support_handle,
  &TestRequestOnly_Event_message_type_support_handle,
