...
static const _TestResponseOnly_Event_type_support_symbol_names_t _TestResponseOnly_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestResponseOnly_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestResponseOnly_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestResponseOnly_Event)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestResponseOnly_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t TestResponseOnly_service_type_support_handle = {
  ...
  &TestResponseOnly_Request_message_type_support_handle,
  &TestResponseOnly_Response_message_type_support_handle,
  &TestResponseOnly_Event_message_type_support_handle,
