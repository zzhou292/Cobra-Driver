...
class Metaclass_SendBytes_Event(type):
    """Metaclass of message 'SendBytes_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_bytes__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_bytes__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_bytes__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_bytes__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_bytes__event
...
class SendBytes_Event(metaclass=Metaclass_SendBytes_Event):
    """Message class 'SendBytes_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rosbridge_test_msgs/SendBytes_Request, 1>',
        'response': 'sequence<rosbridge_test_msgs/SendBytes_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbridge_test_msgs', 'srv'], 'SendBytes_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbridge_test_msgs', 'srv'], 'SendBytes_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rosbridge_test_msgs.srv import SendBytes_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SendBytes_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SendBytes_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rosbridge_test_msgs.srv import SendBytes_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SendBytes_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SendBytes_Response'"
...
class Metaclass_SendBytes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _send_bytes.Metaclass_SendBytes_Event._TYPE_SUPPORT is None:
                _send_bytes.Metaclass_SendBytes_Event.__import_type_support__()
...
class SendBytes(metaclass=Metaclass_SendBytes):
    ...
    from rosbridge_test_msgs.srv._send_bytes import SendBytes_Event as Event
