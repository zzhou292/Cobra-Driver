...
void rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  rosapi_msgs__srv__Publishers_Event__init(message_memory);
}

void rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_fini_function(void * message_memory)
{
  rosapi_msgs__srv__Publishers_Event__fini(message_memory);
}

size_t rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__size_function__Publishers_Event__request(
  const void * untyped_member)
{
  const rosapi_msgs__srv__Publishers_Request__Sequence * member =
    (const rosapi_msgs__srv__Publishers_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_const_function__Publishers_Event__request(
  const void * untyped_member, size_t index)
{
  const rosapi_msgs__srv__Publishers_Request__Sequence * member =
    (const rosapi_msgs__srv__Publishers_Request__Sequence *)(untyped_member);
...
void * rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_function__Publishers_Event__request(
  void * untyped_member, size_t index)
{
  rosapi_msgs__srv__Publishers_Request__Sequence * member =
    (rosapi_msgs__srv__Publishers_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__fetch_function__Publishers_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rosapi_msgs__srv__Publishers_Request * item =
    ((const rosapi_msgs__srv__Publishers_Request *)
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_const_function__Publishers_Event__request(untyped_member, index));
  rosapi_msgs__srv__Publishers_Request * value =
    (rosapi_msgs__srv__Publishers_Request *)(untyped_value);
  *value = *item;
}

void rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__assign_function__Publishers_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rosapi_msgs__srv__Publishers_Request * item =
    ((rosapi_msgs__srv__Publishers_Request *)
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_function__Publishers_Event__request(untyped_member, index));
  const rosapi_msgs__srv__Publishers_Request * value =
    (const rosapi_msgs__srv__Publishers_Request *)(untyped_value);
  *item = *value;
}

bool rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__resize_function__Publishers_Event__request(
  void * untyped_member, size_t size)
{
  rosapi_msgs__srv__Publishers_Request__Sequence * member =
    (rosapi_msgs__srv__Publishers_Request__Sequence *)(untyped_member);
  rosapi_msgs__srv__Publishers_Request__Sequence__fini(member);
  return rosapi_msgs__srv__Publishers_Request__Sequence__init(member, size);
}

size_t rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__size_function__Publishers_Event__response(
  const void * untyped_member)
{
  const rosapi_msgs__srv__Publishers_Response__Sequence * member =
    (const rosapi_msgs__srv__Publishers_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_const_function__Publishers_Event__response(
  const void * untyped_member, size_t index)
{
  const rosapi_msgs__srv__Publishers_Response__Sequence * member =
    (const rosapi_msgs__srv__Publishers_Response__Sequence *)(untyped_member);
...
void * rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_function__Publishers_Event__response(
  void * untyped_member, size_t index)
{
  rosapi_msgs__srv__Publishers_Response__Sequence * member =
    (rosapi_msgs__srv__Publishers_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__fetch_function__Publishers_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rosapi_msgs__srv__Publishers_Response * item =
    ((const rosapi_msgs__srv__Publishers_Response *)
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_const_function__Publishers_Event__response(untyped_member, index));
  rosapi_msgs__srv__Publishers_Response * value =
    (rosapi_msgs__srv__Publishers_Response *)(untyped_value);
  *value = *item;
}

void rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__assign_function__Publishers_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rosapi_msgs__srv__Publishers_Response * item =
    ((rosapi_msgs__srv__Publishers_Response *)
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_function__Publishers_Event__response(untyped_member, index));
  const rosapi_msgs__srv__Publishers_Response * value =
    (const rosapi_msgs__srv__Publishers_Response *)(untyped_value);
  *item = *value;
}

bool rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__resize_function__Publishers_Event__response(
  void * untyped_member, size_t size)
{
  rosapi_msgs__srv__Publishers_Response__Sequence * member =
    (rosapi_msgs__srv__Publishers_Response__Sequence *)(untyped_member);
  rosapi_msgs__srv__Publishers_Response__Sequence__fini(member);
  return rosapi_msgs__srv__Publishers_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi_msgs__srv__Publishers_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rosapi_msgs__srv__Publishers_Event, request),  // bytes offset in struct
    NULL,  // default value
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__size_function__Publishers_Event__request,  // size() function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_const_function__Publishers_Event__request,  // get_const(index) function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_function__Publishers_Event__request,  // get(index) function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__fetch_function__Publishers_Event__request,  // fetch(index, &value) function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__assign_function__Publishers_Event__request,  // assign(index, value) function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__resize_function__Publishers_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rosapi_msgs__srv__Publishers_Event, response),  // bytes offset in struct
    NULL,  // default value
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__size_function__Publishers_Event__response,  // size() function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_const_function__Publishers_Event__response,  // get_const(index) function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__get_function__Publishers_Event__response,  // get(index) function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__fetch_function__Publishers_Event__response,  // fetch(index, &value) function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__assign_function__Publishers_Event__response,  // assign(index, value) function pointer
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__resize_function__Publishers_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_members = {
  "rosapi_msgs__srv",  // message namespace
  "Publishers_Event",  // message name
  3,  // number of fields
  sizeof(rosapi_msgs__srv__Publishers_Event),
  rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_member_array,  // message members
  rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_type_support_handle = {
  0,
  &rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rosapi_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, Publishers_Event)() {
  rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, Publishers_Request)();
  rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, Publishers_Response)();
  if (!rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_type_support_handle.typesupport_identifier) {
    rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t rosapi_msgs__srv__detail__publishers__rosidl_typesupport_introspection_c__Publishers_service_type_support_handle = {
  ...
  &rosapi_msgs__srv__Publishers_Request__rosidl_typesupport_introspection_c__Publishers_Request_message_type_support_handle,
  &rosapi_msgs__srv__Publishers_Response__rosidl_typesupport_introspection_c__Publishers_Response_message_type_support_handle,
  &rosapi_msgs__srv__Publishers_Event__rosidl_typesupport_introspection_c__Publishers_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, Publishers)() {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, Publishers_Event)()->data;
  }
