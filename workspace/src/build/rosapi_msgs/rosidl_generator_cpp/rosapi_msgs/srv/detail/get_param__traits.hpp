...
inline std::string to_yaml(const GetParam_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rosapi_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosapi_msgs::srv::GetParam_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosapi_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosapi_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosapi_msgs::srv::GetParam_Event & msg)
{
  return rosapi_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosapi_msgs::srv::GetParam_Event>()
{
  return "rosapi_msgs::srv::GetParam_Event";
}

template<>
inline const char * name<rosapi_msgs::srv::GetParam_Event>()
{
  return "rosapi_msgs/srv/GetParam_Event";
}

template<>
struct has_fixed_size<rosapi_msgs::srv::GetParam_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rosapi_msgs::srv::GetParam_Event>
  : std::integral_constant<bool, has_bounded_size<rosapi_msgs::srv::GetParam_Request>::value && has_bounded_size<rosapi_msgs::srv::GetParam_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rosapi_msgs::srv::GetParam_Event>
  : std::true_type {};
