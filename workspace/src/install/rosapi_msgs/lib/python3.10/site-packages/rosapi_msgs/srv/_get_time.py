...
class Metaclass_GetTime_Event(type):
    """Metaclass of message 'GetTime_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_time__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_time__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_time__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_time__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_time__event
...
class GetTime_Event(metaclass=Metaclass_GetTime_Event):
    """Message class 'GetTime_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rosapi_msgs/GetTime_Request, 1>',
        'response': 'sequence<rosapi_msgs/GetTime_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosapi_msgs', 'srv'], 'GetTime_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosapi_msgs', 'srv'], 'GetTime_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rosapi_msgs.srv import GetTime_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetTime_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetTime_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rosapi_msgs.srv import GetTime_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetTime_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetTime_Response'"
...
class Metaclass_GetTime(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_time.Metaclass_GetTime_Event._TYPE_SUPPORT is None:
                _get_time.Metaclass_GetTime_Event.__import_type_support__()
...
class GetTime(metaclass=Metaclass_GetTime):
    ...
    from rosapi_msgs.srv._get_time import GetTime_Event as Event
