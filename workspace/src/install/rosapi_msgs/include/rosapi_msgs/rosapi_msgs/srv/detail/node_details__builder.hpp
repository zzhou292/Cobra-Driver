...
class Init_NodeDetails_Event_response
{
public:
  explicit Init_NodeDetails_Event_response(::rosapi_msgs::srv::NodeDetails_Event & msg)
  : msg_(msg)
  {}
  ::rosapi_msgs::srv::NodeDetails_Event response(::rosapi_msgs::srv::NodeDetails_Event::_response_type arg)
  {
...
private:
  ::rosapi_msgs::srv::NodeDetails_Event msg_;
};

class Init_NodeDetails_Event_request
{
public:
  explicit Init_NodeDetails_Event_request(::rosapi_msgs::srv::NodeDetails_Event & msg)
  : msg_(msg)
  {}
  Init_NodeDetails_Event_response request(::rosapi_msgs::srv::NodeDetails_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_NodeDetails_Event_response(msg_);
  }
...
class Init_NodeDetails_Event_info
{
public:
  Init_NodeDetails_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_NodeDetails_Event_request info(::rosapi_msgs::srv::NodeDetails_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_NodeDetails_Event_request(msg_);
  }
...
template<>
inline
auto build<::rosapi_msgs::srv::NodeDetails_Event>()
{
  return rosapi_msgs::srv::builder::Init_NodeDetails_Event_info();
}
