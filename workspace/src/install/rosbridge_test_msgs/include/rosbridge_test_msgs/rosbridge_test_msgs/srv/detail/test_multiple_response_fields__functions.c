...
bool
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__init(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__fini(msg);
    return false;
  }
  // request
  if (!rosbridge_test_msgs__srv__TestMultipleResponseFields_Request__Sequence__init(&msg->request, 0)) {
    rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__fini(msg);
    return false;
  }
  // response
  if (!rosbridge_test_msgs__srv__TestMultipleResponseFields_Response__Sequence__init(&msg->response, 0)) {
    rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__fini(msg);
    return false;
  }
  return true;
...
void
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__fini(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Request__Sequence__fini(&msg->request);
  // response
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Response__Sequence__fini(&msg->response);
}

bool
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__are_equal(const rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * lhs, const rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!rosbridge_test_msgs__srv__TestMultipleResponseFields_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!rosbridge_test_msgs__srv__TestMultipleResponseFields_Response__Sequence__are_equal(
...
bool
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__copy(
  const rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * input,
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!rosbridge_test_msgs__srv__TestMultipleResponseFields_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!rosbridge_test_msgs__srv__TestMultipleResponseFields_Response__Sequence__copy(
...
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event *
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * msg = (rosbridge_test_msgs__srv__TestMultipleResponseFields_Event *)allocator.allocate(sizeof(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event));
  bool success = rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__destroy(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__fini(msg);
...
bool
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence__init(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * data = NULL;

  if (size) {
    data = (rosbridge_test_msgs__srv__TestMultipleResponseFields_Event *)allocator.zero_allocate(size, sizeof(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence__fini(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence *
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence * array = (rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence *)allocator.allocate(sizeof(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence__destroy(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence__are_equal(const rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence * lhs, const rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence__copy(
  const rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence * input,
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbridge_test_msgs__srv__TestMultipleResponseFields_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbridge_test_msgs__srv__TestMultipleResponseFields_Event * data =
      (rosbridge_test_msgs__srv__TestMultipleResponseFields_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
