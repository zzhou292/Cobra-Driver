...
enum
{
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/TestMultipleResponseFields in the package rosbridge_test_msgs.
typedef struct rosbridge_test_msgs__srv__TestMultipleResponseFields_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Request__Sequence request;
  rosbridge_test_msgs__srv__TestMultipleResponseFields_Response__Sequence response;
} rosbridge_test_msgs__srv__TestMultipleResponseFields_Event;

// Struct for a sequence of rosbridge_test_msgs__srv__TestMultipleResponseFields_Event.
typedef struct rosbridge_test_msgs__srv__TestMultipleResponseFields_Event__Sequence
{
