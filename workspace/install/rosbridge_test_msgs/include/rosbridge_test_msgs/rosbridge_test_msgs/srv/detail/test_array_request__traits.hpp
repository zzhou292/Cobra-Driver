...
inline void to_flow_style_yaml(
  const TestArrayRequest_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const TestArrayRequest_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rosbridge_test_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosbridge_test_msgs::srv::TestArrayRequest_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosbridge_test_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosbridge_test_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosbridge_test_msgs::srv::TestArrayRequest_Event & msg)
{
  return rosbridge_test_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosbridge_test_msgs::srv::TestArrayRequest_Event>()
{
  return "rosbridge_test_msgs::srv::TestArrayRequest_Event";
}

template<>
inline const char * name<rosbridge_test_msgs::srv::TestArrayRequest_Event>()
{
  return "rosbridge_test_msgs/srv/TestArrayRequest_Event";
}

template<>
struct has_fixed_size<rosbridge_test_msgs::srv::TestArrayRequest_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rosbridge_test_msgs::srv::TestArrayRequest_Event>
  : std::integral_constant<bool, has_bounded_size<rosbridge_test_msgs::srv::TestArrayRequest_Request>::value && has_bounded_size<rosbridge_test_msgs::srv::TestArrayRequest_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rosbridge_test_msgs::srv::TestArrayRequest_Event>
  : std::true_type {};
