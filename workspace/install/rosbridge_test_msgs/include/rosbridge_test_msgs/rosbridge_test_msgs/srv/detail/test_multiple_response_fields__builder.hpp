...
class Init_TestMultipleResponseFields_Event_response
{
public:
  explicit Init_TestMultipleResponseFields_Event_response(::rosbridge_test_msgs::srv::TestMultipleResponseFields_Event & msg)
  : msg_(msg)
  {}
  ::rosbridge_test_msgs::srv::TestMultipleResponseFields_Event response(::rosbridge_test_msgs::srv::TestMultipleResponseFields_Event::_response_type arg)
  {
...
private:
  ::rosbridge_test_msgs::srv::TestMultipleResponseFields_Event msg_;
};

class Init_TestMultipleResponseFields_Event_request
{
public:
  explicit Init_TestMultipleResponseFields_Event_request(::rosbridge_test_msgs::srv::TestMultipleResponseFields_Event & msg)
  : msg_(msg)
  {}
  Init_TestMultipleResponseFields_Event_response request(::rosbridge_test_msgs::srv::TestMultipleResponseFields_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_TestMultipleResponseFields_Event_response(msg_);
  }
...
class Init_TestMultipleResponseFields_Event_info
{
public:
  Init_TestMultipleResponseFields_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TestMultipleResponseFields_Event_request info(::rosbridge_test_msgs::srv::TestMultipleResponseFields_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_TestMultipleResponseFields_Event_request(msg_);
  }
...
template<>
inline
auto build<::rosbridge_test_msgs::srv::TestMultipleResponseFields_Event>()
{
  return rosbridge_test_msgs::srv::builder::Init_TestMultipleResponseFields_Event_info();
}
