...
enum
{
  rosbridge_test_msgs__srv__AddTwoInts_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rosbridge_test_msgs__srv__AddTwoInts_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/AddTwoInts in the package rosbridge_test_msgs.
typedef struct rosbridge_test_msgs__srv__AddTwoInts_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rosbridge_test_msgs__srv__AddTwoInts_Request__Sequence request;
  rosbridge_test_msgs__srv__AddTwoInts_Response__Sequence response;
} rosbridge_test_msgs__srv__AddTwoInts_Event;

// Struct for a sequence of rosbridge_test_msgs__srv__AddTwoInts_Event.
typedef struct rosbridge_test_msgs__srv__AddTwoInts_Event__Sequence
{
