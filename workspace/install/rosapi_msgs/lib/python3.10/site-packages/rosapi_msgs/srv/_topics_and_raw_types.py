...
class Metaclass_TopicsAndRawTypes_Event(type):
    """Metaclass of message 'TopicsAndRawTypes_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__topics_and_raw_types__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__topics_and_raw_types__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__topics_and_raw_types__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__topics_and_raw_types__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__topics_and_raw_types__event
...
class TopicsAndRawTypes_Event(metaclass=Metaclass_TopicsAndRawTypes_Event):
    """Message class 'TopicsAndRawTypes_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rosapi_msgs/TopicsAndRawTypes_Request, 1>',
        'response': 'sequence<rosapi_msgs/TopicsAndRawTypes_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosapi_msgs', 'srv'], 'TopicsAndRawTypes_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosapi_msgs', 'srv'], 'TopicsAndRawTypes_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rosapi_msgs.srv import TopicsAndRawTypes_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TopicsAndRawTypes_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'TopicsAndRawTypes_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rosapi_msgs.srv import TopicsAndRawTypes_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TopicsAndRawTypes_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'TopicsAndRawTypes_Response'"
...
class Metaclass_TopicsAndRawTypes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _topics_and_raw_types.Metaclass_TopicsAndRawTypes_Event._TYPE_SUPPORT is None:
                _topics_and_raw_types.Metaclass_TopicsAndRawTypes_Event.__import_type_support__()
...
class TopicsAndRawTypes(metaclass=Metaclass_TopicsAndRawTypes):
    ...
    from rosapi_msgs.srv._topics_and_raw_types import TopicsAndRawTypes_Event as Event
