...
class Metaclass_GetROSVersion_Event(type):
    """Metaclass of message 'GetROSVersion_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_ros_version__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_ros_version__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_ros_version__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_ros_version__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_ros_version__event
...
class GetROSVersion_Event(metaclass=Metaclass_GetROSVersion_Event):
    """Message class 'GetROSVersion_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rosapi_msgs/GetROSVersion_Request, 1>',
        'response': 'sequence<rosapi_msgs/GetROSVersion_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosapi_msgs', 'srv'], 'GetROSVersion_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosapi_msgs', 'srv'], 'GetROSVersion_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rosapi_msgs.srv import GetROSVersion_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetROSVersion_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetROSVersion_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rosapi_msgs.srv import GetROSVersion_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetROSVersion_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetROSVersion_Response'"
...
class Metaclass_GetROSVersion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_ros_version.Metaclass_GetROSVersion_Event._TYPE_SUPPORT is None:
                _get_ros_version.Metaclass_GetROSVersion_Event.__import_type_support__()
...
class GetROSVersion(metaclass=Metaclass_GetROSVersion):
    ...
    from rosapi_msgs.srv._get_ros_version import GetROSVersion_Event as Event
