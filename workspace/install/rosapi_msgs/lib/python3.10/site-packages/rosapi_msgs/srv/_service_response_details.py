...
class Metaclass_ServiceResponseDetails_Event(type):
    """Metaclass of message 'ServiceResponseDetails_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__service_response_details__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__service_response_details__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__service_response_details__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__service_response_details__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__service_response_details__event
...
class ServiceResponseDetails_Event(metaclass=Metaclass_ServiceResponseDetails_Event):
    """Message class 'ServiceResponseDetails_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rosapi_msgs/ServiceResponseDetails_Request, 1>',
        'response': 'sequence<rosapi_msgs/ServiceResponseDetails_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosapi_msgs', 'srv'], 'ServiceResponseDetails_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosapi_msgs', 'srv'], 'ServiceResponseDetails_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rosapi_msgs.srv import ServiceResponseDetails_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ServiceResponseDetails_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ServiceResponseDetails_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rosapi_msgs.srv import ServiceResponseDetails_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ServiceResponseDetails_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ServiceResponseDetails_Response'"
...
class Metaclass_ServiceResponseDetails(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _service_response_details.Metaclass_ServiceResponseDetails_Event._TYPE_SUPPORT is None:
                _service_response_details.Metaclass_ServiceResponseDetails_Event.__import_type_support__()
...
class ServiceResponseDetails(metaclass=Metaclass_ServiceResponseDetails):
    ...
    from rosapi_msgs.srv._service_response_details import ServiceResponseDetails_Event as Event
