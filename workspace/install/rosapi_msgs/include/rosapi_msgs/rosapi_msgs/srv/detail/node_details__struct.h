...
enum
{
  rosapi_msgs__srv__NodeDetails_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rosapi_msgs__srv__NodeDetails_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/NodeDetails in the package rosapi_msgs.
typedef struct rosapi_msgs__srv__NodeDetails_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rosapi_msgs__srv__NodeDetails_Request__Sequence request;
  rosapi_msgs__srv__NodeDetails_Response__Sequence response;
} rosapi_msgs__srv__NodeDetails_Event;

// Struct for a sequence of rosapi_msgs__srv__NodeDetails_Event.
typedef struct rosapi_msgs__srv__NodeDetails_Event__Sequence
{
