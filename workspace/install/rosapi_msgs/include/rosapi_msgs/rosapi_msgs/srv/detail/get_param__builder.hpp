...
class Init_GetParam_Event_response
{
public:
  explicit Init_GetParam_Event_response(::rosapi_msgs::srv::GetParam_Event & msg)
  : msg_(msg)
  {}
  ::rosapi_msgs::srv::GetParam_Event response(::rosapi_msgs::srv::GetParam_Event::_response_type arg)
  {
...
private:
  ::rosapi_msgs::srv::GetParam_Event msg_;
};

class Init_GetParam_Event_request
{
public:
  explicit Init_GetParam_Event_request(::rosapi_msgs::srv::GetParam_Event & msg)
  : msg_(msg)
  {}
  Init_GetParam_Event_response request(::rosapi_msgs::srv::GetParam_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetParam_Event_response(msg_);
  }
...
class Init_GetParam_Event_info
{
public:
  Init_GetParam_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetParam_Event_request info(::rosapi_msgs::srv::GetParam_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetParam_Event_request(msg_);
  }
...
template<>
inline
auto build<::rosapi_msgs::srv::GetParam_Event>()
{
  return rosapi_msgs::srv::builder::Init_GetParam_Event_info();
}
